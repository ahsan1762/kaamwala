...
router.get('/withdrawal-requests', protect, authorize('admin'), getWithdrawalRequests);
router.patch('/withdrawal-requests/:id/approve', protect, authorize('admin'), approveWithdrawalRequest);
router.patch('/withdrawal-requests/:id/reject', protect, authorize('admin'), rejectWithdrawalRequest);
