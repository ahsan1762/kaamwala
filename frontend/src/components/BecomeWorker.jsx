...
const BecomeWorker = () => {
    ...
    const handlePhoneChange = (e) => {
        ...
        digits = digits.slice(0, 11); // max 11 digits
    ...
    const handleCnicChange = (e) => {
        let digits = e.target.value.replace(/\D/g, ''); // strip non-digits
        digits = digits.slice(0, 13); // max 13 digits
        let formatted = digits;
        if (digits.length > 12) {
    ...
    const handleSubmit = async (e) => {
        ...
        // Run step 1 validations before submitting (for new registration mode)
        if (!isProfileCreationOnly && !validateStep()) {
            return;
        }
                                    ...
                                    <div className="form-row">
                                        ...
                                        <div className="form-group">
                                            ...
                                            <div className="input-wrapper">
                                                ...
                                                <input type="tel" name="phone" required className="input-field" placeholder="03xx-xxxxxxx" value={formData.phone} onChange={handlePhoneChange} disabled={isProfileCreationOnly && formData.phone} maxLength="12" />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="form-group">
                                        ...
                                        <div className="input-wrapper">
                                            ...
                                            <input type="text" name="cnic" required className="input-field" placeholder="xxxxx-xxxxxxx-x" value={formData.cnic} onChange={handleCnicChange} disabled={isProfileCreationOnly} maxLength="15" />
                                        </div>
                                    </div>
                                    {!isProfileCreationOnly && (
                                        <div className="form-group">
